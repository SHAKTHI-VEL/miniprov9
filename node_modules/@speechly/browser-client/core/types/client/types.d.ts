...
export declare const DecoderDefaultOptions: {
    connect: boolean;
    apiUrl: string;
    sampleRate: number;
    debug: boolean;
...
export declare const StreamDefaultOptions: StreamOptions;
/**
 ...
 * @internal
 */
export declare class ListenerArray<T> extends Array<T> {
...
export declare class EventCallbacks {
    stateChangeCbs: ListenerArray<(state: DecoderState) => void>;
    transcriptCbs: ListenerArray<(contextId: string, segmentId: number, word: Word) => void>;
    entityCbs: ListenerArray<(contextId: string, segmentId: number, entity: Entity) => void>;
    intentCbs: ListenerArray<(contextId: string, segmentId: number, intent: Intent) => void>;
    segmentChangeCbs: ListenerArray<(segment: Segment) => void>;
    tentativeTranscriptCbs: ListenerArray<(contextId: string, segmentId: number, words: Word[], text: string) => void>;
    tentativeEntityCbs: ListenerArray<(contextId: string, segmentId: number, entities: Entity[]) => void>;
    tentativeIntentCbs: ListenerArray<(contextId: string, segmentId: number, intent: Intent) => void>;
    contextStartedCbs: ListenerArray<(contextId: string) => void>;
    contextStoppedCbs: ListenerArray<(contextId: string) => void>;
    onVadStateChange: ListenerArray<(active: boolean) => void>;
}
/**
